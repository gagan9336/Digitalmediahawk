(function ($) {
	...
	$(window).scroll(function() {
	  ...
	  if (scroll >= box - header) {
	    $("header").addClass("background-header1");
	  } else {
	    $("header").removeClass("background-header1");
	  }
	});
	...
	if(navCheck) {
	  console.log("navCheck exist");
	  navbar.classList.remove('header-area2');
	}

	// var elem = document.getElementById("button-remove");
	// var buttonCheck = document.getElementById("buttonCheck");

	// if(buttonCheck) {
	// 	console.log("button dont need here");
	// 	elem.remove();
	// }
